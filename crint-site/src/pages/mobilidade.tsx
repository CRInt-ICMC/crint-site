...
const MobAlunos = () => {
    return (
        <>                
            <h3>
                Solicitações de auxílios financeiros
            </h3>
            <p>
...
const Mobilidade = () => {
    return (
        <div id="mobilidade-root">
            ...
            <TopicSection 
                title='Mobilidade Internacional para Alunos do ICMC/USP' 
                body={MobAlunos()}
                style={{color: 'white', backgroundColor: '#0D8694'}}
                />
            <TopicSection
                title='Internacionalização de Servidores Técnicos e Administrativos do ICMC/USP'
                body={InterServidores()}
                />
        </div>
    );
}
